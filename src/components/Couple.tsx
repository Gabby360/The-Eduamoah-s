    ...
    <section id="couple" className="py-24 bg-[#11221c] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          ...
          {/* Bride Card */}
          <div className="group relative bg-[#0a1713] p-4 border border-[#f1c65a]/30 shadow-2xl transition-all duration-500 hover:border-[#f1c65a]/60">
            <div className="relative overflow-hidden aspect-[3/4] mb-6">
              ...
              <div className="absolute top-2 left-2 w-6 h-6 border-t border-l border-[#f1c65a]" />
              <div className="absolute bottom-2 right-2 w-6 h-6 border-b border-r border-[#f1c65a]" />
            </div>
