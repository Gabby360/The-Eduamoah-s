  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-36 pb-16 lg:pb-2 lg:translate-y-16 flex flex-col items-center justify-end min-h-screen">
        ...
        <h1 className="hero-title font-heading text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl tracking-[0.06em] md:tracking-[0.1em] text-[#FBF7EF] font-normal uppercase text-shadow-hero mb-4 lg:mb-2 leading-none text-center z-10">
          {weddingDetails.couple.coupleName}
        </h1>

        <p className="hero-tagline font-heading italic text-lg sm:text-xl md:text-2xl text-[#FBF7EF] font-light mb-6 lg:mb-2 text-shadow-hero">
